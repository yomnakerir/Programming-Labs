...
public:
	...
	clsProgrammer(int id, string firstName, string secondName, string email, string phone, float salary, string department, string title, string mainLanguage)
		:clsEmployee(id, firstName, secondName, email, phone, salary, department, title) {
...
int main()
{
	...
	clsProgrammer programmer1(20, "Ziyad", "Mohamed", "ziyad@gmail.com", "0457884", 20000, "CS", "CEO", "C++");
	programmer1.print();
